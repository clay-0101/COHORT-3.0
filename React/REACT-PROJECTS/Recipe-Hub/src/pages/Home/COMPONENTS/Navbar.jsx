...
const Navbar = () => {
    let {setOnHome,cartQuantity} = useContext(MyStore)
        ...
        <div className='flex w-full justify-center items-center gap-[5vw] bg-white py-2 border-b border-[#aca7a79e]'>
            ...
            <div className='flex items-center gap-3'>
                ...
                className='cursor-pointer active:scale-98'
                    size={28}/>
                    <span className='relative right-5 -top-2 bg-[#fd6800] px-1.5  font-medium text-[12px]  rounded-full'>{cartQuantity}</span>
