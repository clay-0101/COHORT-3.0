...
const Cart = () => {
    let { setCartToggle, cartData, setCartData } = useContext(MyStore)
            ...
            <div className='bg-[#111111] h-screen w-full sm:w-[70%] md:w-[45%] lg:w-[28%] border-[0.1px] border-[#f2f1f12d] flex flex-col'>
                ...
                {!isEmpty ? (
                    <div className='flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center'>
                        ...
                        <button className='mt-2 bg-[#c8f400] hover:bg-[#b5dd00] text-black font-[600] px-6 py-2.5 rounded-full transition-colors duration-200'>
                            Browse Products
                        </button>
                    </div>
                ) : (
                    <>
                        ...
                        <div className='border-t-[0.1px] border-[#f2f1f1d4] p-4.5 flex flex-col gap-3'>
                            ...
                            <p className='text-center text-gray-500 text-xs hover:text-white cursor-pointer transition-colors duration-200'>
                                Clear cart
                            </p>
                        </div>
                    </>
