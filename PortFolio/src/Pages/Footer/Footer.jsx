...
const Footer = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const hoverLetters = gsap.utils.toArray(
        ".carry-hover-letter"
      );
  ...
  return (
    <>
      ...
      <footer
        ref={footerRef}
        className="footer-main fixed inset-x-0 bottom-0 z-0 h-screen overflow-hidden bg-[#08090a] text-white"
      >
        ...
        <div className="relative z-10 flex h-screen flex-col px-5 pt-7 md:px-10 md:pt-9 lg:px-[5vw]">
          <div className="flex items-center justify-between">
            <a
              href="/"
              className="footer-top-item group flex items-center gap-3"
            >
          ...
          <div className="mt-15 grid grid-cols-1 gap-12 md:mt-20 md:grid-cols-12 lg:mt-25">
